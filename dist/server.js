...
server.registerTool('findCustomerByFirstName', {
    ...
    console.log('>>>> ', `${BASE}/users/filter?key=firstName&value=${firstName}`);
    const res = await fetch(`${BASE}/users/filter?key=firstName&value=${firstName}`, {
